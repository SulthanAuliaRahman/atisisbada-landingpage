...
const AdminFooter = () => {
  const [footerData, setFooterData] = useState({
    dataKantor: [
      ...
      { type: "alamat", text: "Jl. Contoh No.1, Jakarta" },
      { type: "telp", text: "+62 812 3456 7890" },
      { type: "email", text: "info@pilarwahana.com" },
    ],
    informasi: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    kontak: [
      {
        platform: "Instagram",
        url: "https://www.instagram.com/atisisbada.id/",
      },
      { platform: "Whatsapp", url: "0899999999" },
    ],
    lokasi: [
      { type: "Latitude", value: "1" },
      { type: "Longitude", value: "2" },
    ],
  });
        ...
        <div className="bg-white shadow-md rounded-md p-4 space-y-4">
          ...
          {footerData.dataKantor.map((item, i) => (
            <div key={i} className="space-y-2">
              ...
              {item.type === "logo" ? (
                <label className="flex flex-col items-center justify-center w-full h-15 border-2 border-dashed border-gray-300 rounded cursor-pointer hover:border-blue-500 transition">
                  <svg
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (file) {
                        ...
                        handleChange("dataKantor", i, "src", url);
                        handleChange("dataKantor", i, "fileName", file.name);
                      }
                    }}
                  />
                </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-[1fr_auto] gap-0 w-full">
                    ...
                    {item.type === "logo" ? (
                      ...
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          className="h-5 w-5"
                        />
                        <span className="footer-text text-sm">
                          {item.text || `${item.type} belum diisi`}
                        </span>
                      </div>
                    )}
                  </div>
              ...
              <div className="flex flex-col px-10 py-14 bg-footer">
                ...
                <p className="footer-text text-sm">
                  {footerData.informasi || "Informasi belum diisi"}
                </p>
              </div>
              ...
              <div className="flex flex-col px-10 py-14 bg-footer">
                ...
                {footerData.lokasi[0].value && footerData.lokasi[1].value ? (
                  <iframe
                    title="Lokasi"
                    src={`https://maps.google.com/maps?q=${footerData.lokasi[0].value},${footerData.lokasi[1].value}&z=15&output=embed`}
                  ...
                  <div className="w-full h-40 bg-gray-200 rounded flex items-center justify-center text-gray-500 text-sm">
                    Peta akan muncul setelah lokasi diisi
                  </div>
                )}
              </div>
